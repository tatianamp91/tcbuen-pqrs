...
public class ParametrosPqrView implements Serializable {
    ...
    public void rowEventListener(RowEditEvent e) {
        try {
            ParametrosPqrDTO parametrosPqrDTO = (ParametrosPqrDTO) e.getObject();

            if (txtDescripcionParam == null) {
                txtDescripcionParam = new InputText();
            }

            txtDescripcionParam.setValue(parametrosPqrDTO.getDescripcionParam());
            ...
            txtUsuarioUltimaModificacion.setValue(parametrosPqrDTO.getUsuarioUltimaModificacion());
            ...
            txtFechaUltimaModificacion.setValue(parametrosPqrDTO.getFechaUltimaModificacion());
    ...
    public String action_clear() {
        ...
        if (txtDescripcionParam != null) {
            ...
            txtDescripcionParam.setDisabled(true);
        }
        ...
        if (txtValorParam != null) {
            ...
            txtValorParam.setDisabled(true);
        }
    ...
    public void listener_txtId() {
        try {
            Long idParam = FacesUtils.checkLong(txtIdParam);
            entity = (idParam != null)
                ? businessDelegatorView.getParametrosPqr(idParam) : null;
        } catch (Exception e) {
            entity = null;
        }
    ...
    public String action_edit(ActionEvent evt) {
        selectedParametrosPqr = (ParametrosPqrDTO) (evt.getComponent()
                                                       .getAttributes()
                                                       .get("selectedParametrosPqr"));
        txtDescripcionParam.setValue(selectedParametrosPqr.getDescripcionParam());
        txtDescripcionParam.setDisabled(false);
        ...
        txtFechaCreacion.setDisabled(false);
        txtFechaUltimaModificacion.setValue(selectedParametrosPqr.getFechaUltimaModificacion());
        txtFechaUltimaModificacion.setDisabled(false);
        txtUsuarioCreador.setValue(selectedParametrosPqr.getUsuarioCreador());
        txtUsuarioCreador.setDisabled(false);
        txtUsuarioUltimaModificacion.setValue(selectedParametrosPqr.getUsuarioUltimaModificacion());
        txtUsuarioUltimaModificacion.setDisabled(false);
    ...
    public String action_create() {
        try {
            ...
            entity.setDescripcionParam(FacesUtils.checkString(
                    txtDescripcionParam));
