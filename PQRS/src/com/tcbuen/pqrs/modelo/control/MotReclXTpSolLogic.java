...
*/
@Scope("singleton")
@Service("MotReclXTpSolLogic")
public class MotReclXTpSolLogic implements IMotReclXTpSolLogic {
    /**
    ...
    */
    ...
    public List<MotReclXTpSol> getMotReclXTpSol() throws Exception {
        List<MotReclXTpSol> list = new ArrayList<MotReclXTpSol>();

        try {
            list = motReclXTpSolDAO.findAll();
        } catch (Exception e) {
    ...
    public void deleteMotReclXTpSol(MotReclXTpSol entity)
        throws Exception {
        if (entity == null) {
            throw new ZMessManager().new NullEntityExcepcion("MotReclXTpSol");
        }

        if (entity.getIdMotReclXTpSol() == null) {
            throw new ZMessManager().new EmptyFieldException("idMotReclXTpSol");
        }
    ...
    public List<MotReclXTpSolDTO> getDataMotReclXTpSol()
        throws Exception {
        try {
            List<MotReclXTpSol> motReclXTpSol = motReclXTpSolDAO.findAll();

            List<MotReclXTpSolDTO> motReclXTpSolDTO = new ArrayList<MotReclXTpSolDTO>();

            for (MotReclXTpSol motReclXTpSolTmp : motReclXTpSol) {
                MotReclXTpSolDTO motReclXTpSolDTO2 = new MotReclXTpSolDTO();

                motReclXTpSolDTO2.setIdMotReclXTpSol(motReclXTpSolTmp.getIdMotReclXTpSol());
                motReclXTpSolDTO2.setIdMotRecl_MotivoReclamacion((motReclXTpSolTmp.getMotivoReclamacion()
                                                                                  .getIdMotRecl() != null)
                    ? motReclXTpSolTmp.getMotivoReclamacion().getIdMotRecl()
                    : null);
                motReclXTpSolDTO2.setIdTpSolPqr_TipoSolicitudPqr((motReclXTpSolTmp.getTipoSolicitudPqr()
                                                                                  .getIdTpSolPqr() != null)
                    ? motReclXTpSolTmp.getTipoSolicitudPqr().getIdTpSolPqr()
                    : null);
                motReclXTpSolDTO.add(motReclXTpSolDTO2);
            }
    ...
    public MotReclXTpSol getMotReclXTpSol(Long idMotReclXTpSol)
        throws Exception {
        MotReclXTpSol entity = null;

        try {
            entity = motReclXTpSolDAO.findById(idMotReclXTpSol);
        } catch (Exception e) {
            throw new ZMessManager().new FindingException("MotReclXTpSol");
        } finally {
        }
    ...
    public List<MotReclXTpSol> findPageMotReclXTpSol(String sortColumnName,
        ...
        throws Exception {
        List<MotReclXTpSol> entity = null;

        try {
            entity = motReclXTpSolDAO.findPage(sortColumnName, sortAscending,
                    startRow, maxResults);
        } catch (Exception e) {
            throw new ZMessManager().new FindingException("MotReclXTpSol Count");
        } finally {
        }
    ...
    * de busqueda voy a hacer.., ejemplo: where nombre=william o where nombre<>william,
    ...
    public List<MotReclXTpSol> findByCriteria(Object[] variables,
        ...
        try {
            list = motReclXTpSolDAO.findByCriteria(where);
        } catch (Exception e) {
            throw new Exception(e.getMessage());
        } finally {
        }
