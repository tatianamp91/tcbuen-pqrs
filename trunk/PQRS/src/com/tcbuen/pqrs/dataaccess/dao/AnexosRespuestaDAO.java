 ...
 * AnexosRespuesta entities. Transaction control of the save(), update() and
 * delete() operations can directly support Spring container-managed
 * transactions or they can be augmented to handle user-managed Spring
 * transactions. Each of these methods provides additional information for how
 * to configure it for the desired type of transaction control.
 *
 * @see lidis.AnexosRespuesta
 */
@Scope("singleton")
@Repository("AnexosRespuestaDAO")
public class AnexosRespuestaDAO extends HibernateDaoImpl<AnexosRespuesta, Long>
    implements IAnexosRespuestaDAO {
    private static final Logger log = LoggerFactory.getLogger(AnexosRespuestaDAO.class);
    @Resource
    private SessionFactory sessionFactory;

    public static IAnexosRespuestaDAO getFromApplicationContext(
