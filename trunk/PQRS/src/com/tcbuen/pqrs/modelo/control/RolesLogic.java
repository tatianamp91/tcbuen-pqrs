...
public class RolesLogic implements IRolesLogic {
    ...
    */
    ...
    public void deleteRoles(Roles entity) throws Exception {
        ...
        try {
            usuariosInternoses = usuariosInternosDAO.findByProperty("roles.idRol",
                    entity.getIdRol());
    ...
    public List<RolesDTO> getDataRoles() throws Exception {
        try {
            ...
            for (Roles rolesTmp : roles) {
                ...
                rolesDTO2.setFechaUltimaModificacion(rolesTmp.getFechaUltimaModificacion());
                rolesDTO2.setNombreRol((rolesTmp.getNombreRol() != null)
                    ? rolesTmp.getNombreRol() : null);
                rolesDTO2.setUsuarioCreador((rolesTmp.getUsuarioCreador() != null)
                    ? rolesTmp.getUsuarioCreador() : null);
                rolesDTO2.setUsuarioUltimaModificacion((rolesTmp.getUsuarioUltimaModificacion() != null)
                    ? rolesTmp.getUsuarioUltimaModificacion() : null);
