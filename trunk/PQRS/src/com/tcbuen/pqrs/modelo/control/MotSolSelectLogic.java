...
*/
@Scope("singleton")
@Service("MotSolSelectLogic")
public class MotSolSelectLogic implements IMotSolSelectLogic {
    /**
    ...
    */
    ...
    public List<MotSolSelect> getMotSolSelect() throws Exception {
        List<MotSolSelect> list = new ArrayList<MotSolSelect>();

        try {
            list = motSolSelectDAO.findAll();
        } catch (Exception e) {
    ...
    public void saveMotSolSelect(MotSolSelect entity) throws Exception {
        try {
            ...
            if (entity.getIdMotSolSelected() == null) {
            ...
            if ((entity.getIdMotSolSelected() != null) &&
                    (Utilities.checkNumberAndCheckWithPrecisionAndScale("" +
                        entity.getIdMotSolSelected(), 10, 0) == false)) {
            ...
            if (getMotSolSelect(entity.getIdMotSolSelected()) != null) {
                throw new ZMessManager(ZMessManager.ENTITY_WITHSAMEKEY);
            }

            motSolSelectDAO.save(entity);
        } catch (Exception e) {
            throw e;
        } finally {
        }
    ...
    public void deleteMotSolSelect(MotSolSelect entity)
        throws Exception {
        if (entity == null) {
            throw new ZMessManager().new NullEntityExcepcion("MotSolSelect");
        }

        if (entity.getIdMotSolSelected() == null) {
            throw new ZMessManager().new EmptyFieldException("idMotSolSelected");
        }

        try {
            motSolSelectDAO.delete(entity);
        } catch (Exception e) {
            throw e;
        } finally {
        }
    ...
    public List<MotSolSelectDTO> getDataMotSolSelect()
        throws Exception {
        try {
            List<MotSolSelect> motSolSelect = motSolSelectDAO.findAll();

            List<MotSolSelectDTO> motSolSelectDTO = new ArrayList<MotSolSelectDTO>();

            for (MotSolSelect motSolSelectTmp : motSolSelect) {
                MotSolSelectDTO motSolSelectDTO2 = new MotSolSelectDTO();

                motSolSelectDTO2.setIdMotSolSelected(motSolSelectTmp.getIdMotSolSelected());
                motSolSelectDTO2.setIdMotSol_MotivoSolicitud((motSolSelectTmp.getMotivoSolicitud()
                                                                             .getIdMotSol() != null)
                    ? motSolSelectTmp.getMotivoSolicitud().getIdMotSol() : null);
                motSolSelectDTO2.setIdSolPqr_SolicitudPqr((motSolSelectTmp.getSolicitudPqr()
                                                                          .getIdSolPqr() != null)
                    ? motSolSelectTmp.getSolicitudPqr().getIdSolPqr() : null);
                motSolSelectDTO.add(motSolSelectDTO2);
            }

            return motSolSelectDTO;
        } catch (Exception e) {
            throw e;
        }
    }
    ...
    public MotSolSelect getMotSolSelect(Long idMotSolSelected)
        ...
        try {
            entity = motSolSelectDAO.findById(idMotSolSelected);
        } catch (Exception e) {
            throw new ZMessManager().new FindingException("MotSolSelect");
        } finally {
        }
    ...
    public List<MotSolSelect> findPageMotSolSelect(String sortColumnName,
        ...
        throws Exception {
        List<MotSolSelect> entity = null;

        try {
            entity = motSolSelectDAO.findPage(sortColumnName, sortAscending,
                    startRow, maxResults);
        } catch (Exception e) {
            throw new ZMessManager().new FindingException("MotSolSelect Count");
        } finally {
        }
    ...
    * de busqueda voy a hacer.., ejemplo: where nombre=william o where nombre<>william,
    ...
    public List<MotSolSelect> findByCriteria(Object[] variables,
        ...
        try {
            list = motSolSelectDAO.findByCriteria(where);
        } catch (Exception e) {
